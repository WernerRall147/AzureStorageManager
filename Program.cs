...
namespace AzureStorageManager
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            Console.Write("Enter your Azure Storage Account Key: ");
            string storageAccountKey = Console.ReadLine() ?? "";
            ...
            // Check if storage account details are present
            if (string.IsNullOrEmpty(storageAccountName) || string.IsNullOrEmpty(storageAccountKey))
            {
                Console.WriteLine("Storage account name or key is missing. Please check your input.");
                return;
            }
            ...
            else if (choice == "2")
            {
                ...
                try
                {
                    // Construct the URI and ensure it’s valid
                    ...
                    var shareServiceClient = new ShareServiceClient(new Uri(fileShareUri), 
                        new StorageSharedKeyCredential(storageAccountName, storageAccountKey));
        ...
        private static void DisplayIntroduction()
        {
            ...
            Console.WriteLine("- Azure Storage Account Name and Key");
            ...
            Console.WriteLine("1. Enter your Azure Storage Account name and key when prompted.");
